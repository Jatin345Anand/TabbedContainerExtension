 ...
 define(["jquery", "qlik", "./properties", "css!./css/styles.css"], function(S, g, t, e) {
    ...
    return {
        ...
        paint: function(t, n) {
            ...
            // console.log(t[0].childNodes[0]);
            // console.log(t[0].childNodes[0].style);
            // console.log(t[0].childNodes[0].style.display);
            // console.log(g);
            console.log(e.select_tabsRow_view);
            if(e.select_tabsRow_view==1){
                if(t[0].childNodes){
                    console.log(t[0].childNodes[0]);
                    if(t[0].childNodes[0]){
                        console.log(t[0].childNodes[0].style);
                        t[0].childNodes[0].style.display = '';
                         console.log(t[0].childNodes[0].style.display);
                    }
            ...
            if(e.select_tabsRow_view==2){
                if(t[0].childNodes){
                    ...
                    if(t[0].childNodes[0]){
                        console.log(t[0].childNodes[0].style);
                        t[0].childNodes[0].style.display = 'block';
                         console.log(t[0].childNodes[0].style.display);
                    }
            ...
            addExportButton = i && (f || !this.previousState || this.previousState.currActiveTab !== r),
            this.previousState = {
                canInteract: p,
                noSelections: d,
                currActiveTab: r,
